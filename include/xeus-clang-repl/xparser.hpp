...
//===----------------------------------------------------------------------===//
//
//  This file defines the inteface for parsing, trimming and options parsing.
//  FIXME: Likely we do not need these and could be replaced by deeper
//  integration with the LLVM API.
//
//===----------------------------------------------------------------------===//
